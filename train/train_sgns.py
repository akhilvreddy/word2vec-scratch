...
def train_sgns():
    ...
    dataset = SGNSDataset(pairs, word2idx, negative_samples=NEGATIVE_SAMPLES)
    ...
    for epoch in range(EPOCHS):
        ...
        for center_words, pos_words, neg_words in dataloader:
            ...
            pos_words = pos_words.to(device)        # (B,)
    ...
    # Save model
    torch.save(model.state_dict(), 'models/sgns_word2vec.pth')
    print("Training completed! Model saved to models/sgns_word2vec.pth")
